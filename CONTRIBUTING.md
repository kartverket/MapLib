# Contributing to MapLib

Thanks for your interest in contributing to MapLib.

## Submitting Bug Reports

Please use the [GitHub issue tracker](https://github.com/kartverket/MapLib/issues). Before creating a new issue, do a quick search to see if the problem has been reported already.
